...
GO
 ...
 USE [BD_PROYECTO]
GO
 ALTER TABLE BD_PROYECTO.DBO.TIPOTACTICA ADD IDTipoObjetivoEstrategico INT 
...
(8,'Posicionar a Be+Group​ como la sombrilla del grupo en el 40 % de nuestros clientes activos 2022 y 100 % en cliente interno​',1,6808,2023);
 ...
 --registros de tacticas año 2023
  INSERT INTO [BD_PROYECTO].[dbo].[TipoTactica] (ID,NOMBRE,ACTIVO,IDUSUARIOREGISTRA,ANNO,IDTipoObjetivoEstrategico) VALUES 
(1,'Hacer acuerdos de nivel de servicio con base en lo que le genera dolor al cliente y está en la caracterización, creando banderas rojas según cada cliente.',1,6808,2023,1),
(2,'Apropiar los atributos y  resultados de nuestros productos y servicios como información valiosa para la toma de decisiones en el nivel táctico de las instituciones educativas, en el componente de gestión académica.',1,6808,2023,2),
(3, 'Realizar eventos de valor compartido entre aliados estratégicos del sector educativo',1,6808,2023,3),
(4, 'Incrementar la tasa de adquisición de clientes identificando el encaje que hay entre las necesidades del prospecto y las beneficios y ventajas que ofrecemos',1,6808,2023,4),
(5, 'Generar actividades masivas a traves de canales digitales y presenciales que permitan el contacto con grupos de interes, clientes potenciales de los cursos preifes para generacion de prospectos cualificados ',1,6808,2023,5),
(6, 'Establecer en los puntos de contacto con el cliente las actividades de gestion comercial que garanticen la efectividad en el cierre de ventas ',1,6808,2023,5),
(7, 'Diversificar el  producto para  que respoda las necesidades especificas del cliente.',1,6808,2023,5),
(8, 'Incrementar el engagement con los clientes identificando el encaje que hay entre sus necesidades  y las beneficios y ventajas que ofrecemos',1,6808,2023,6),
(9, 'Identificar el journey map en la prestación del servicio del 2022 y establecer los puntos de dolor para generar acciones e indicadores sobre ellas en el 2023',1,6808,2023,7),
(10, 'Despliegue de actividades disruptivas que generen reconocimiento en nuestros clientes internos y externos de Be+ Group como sombrilla del grupo.',1,6808,2023,8);


------------PARTE DE SAMRT
-- 1.  GENERACION DE LAS RUTAS Y NUEVOS FORMULARIOS PARA NO AFECTAR LOS ACTUALES PROCESOS:
Registrar Proyecto (LID)  --objeto duplicado  
